...
const Hero = () => {
  ...
  return <section className="overflow-hidden relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50" id="hero" style={{
      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2 relative">
            ...
            <div 
              className="absolute inset-0 rounded-2xl opacity-100 bg-cover bg-center bg-no-repeat"
              style={{
            ...
            <div className="relative z-10 p-8 lg:p-12">
              <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium text-white mb-3 sm:mb-6 opacity-0 animate-fade-in" style={{
                animationDelay: "0.1s"
              }}>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight opacity-0 animate-fade-in text-white" style={{
                ...
                <span className="text-blue-300">Drive Personalization.</span><br className="hidden sm:inline" />
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in" style={{
                ...
                <button className="flex items-center justify-center group w-full sm:w-auto text-center bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white font-semibold py-4 px-6 rounded-lg border-2 border-white/30 hover:border-white/50 transition-all duration-200">
                  Talk to an Expert
                  <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
                </button>
              </div>
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0">
            {!showVideo ? <div className="relative z-10 animate-fade-in" style={{
              animationDelay: "0.9s"
            }}>
                <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
                  <img ref={imageRef} src="https://images.unsplash.com/photo-1518770660439-4636190af475?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="AI Technology and Data Processing" className="w-full h-auto aspect-video object-cover" />
              ...
              </div> : <div className="relative z-10 animate-fade-in">
                <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
