...
import {
  ...
  ShoppingBag,
  Layers,
} from "lucide-react"; // Icon representations for now
  ...
  return (
    <section className="py-20 bg-gray-100">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/* Icons Section as Placeholders */}
        <div className="mt-12 text-center">
          <p className="text-gray-700 text-lg mb-6">
            Datagets solution is optimized for
          </p>
          <div className="flex justify-center gap-10 items-center flex-wrap">
            <div className="flex flex-col items-center">
              <Layers className="text-gray-800 w-10 h-10 mb-2" />
              <span className="text-sm text-gray-600">Adobe</span>
            </div>
            <div className="flex flex-col items-center">
              <Cloud className="text-gray-800 w-10 h-10 mb-2" />
              <span className="text-sm text-gray-600">Salesforce</span>
            </div>
            <div className="flex flex-col items-center">
              <ShoppingBag className="text-gray-800 w-10 h-10 mb-2" />
